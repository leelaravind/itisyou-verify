...
| `api_security_privacy` + the 156 `SEC-*` | all                                                                      | Public repo, public endpoint, customer data rendered to a browser. `SEC-206` passes as of 19 September 2026; an earlier revision of this table said it was failing after it had started passing. |
