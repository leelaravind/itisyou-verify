...
| Production                  | `954a5a71750f`, read back from `GET https://verify.itisyou.app/health` at 16:10Z on 21 Sept |
| Staging                     | `954a5a71750f`, deployed 16:05Z from the same gate artefact and verified signed in before production |
...
| `curl -s https://verify.itisyou.app/health`                                                                                                            | commit `954a5a71750f` (16:10Z, 21 Sept)                                                                  |
| `curl -s https://verify-itisyou-staging.kpleelaaravind.workers.dev/health`                                                                              | commit `954a5a71750f` (16:05Z, 21 Sept)                                                                  |
