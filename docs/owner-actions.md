...
| O6  | **In progress:** sign-in link for the outlook address sent from production at 12:00:41Z (`sign_in_link` row `sent`). Open it in the same Chrome profile within 15 minutes; `/app` then shows "Owner test workspace" and I drive the sandbox checkout.                                                                                                            | D1.2 to D1.6.                    |
